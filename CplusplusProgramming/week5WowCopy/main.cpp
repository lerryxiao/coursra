...
public:
    ...
    // 获取将要出生的战士的名字
    string getWarriorName(int position)
    { return warriorNames[position]; }
...
public:
    ...
    void print()
    {
        cout << "It has a " << this->getWeaponName() << ",and it's morale is " << setprecision(2) << fixed
             << this->getMorale() << endl;
    }
};
                ...
                else
                {
                    ...
                    while (true)
                    {
                        if (redOne.getLifeValue() >= redOne.getWarriorValue(redPosition))
                        {
                            ...
                            {
                                dragon theDragon(redOne.getCount(), redOne.getWarriorValue(redPosition),
                                                 redOne.getLifeValue());
                                theDragon.print();
                            }
                            ...
                            {
                                lion theLion(redOne.getCount(), redOne.getWarriorValue(redPosition),
                                             redOne.getLifeValue());
                                theLion.print();
                            }
                            else
                ...
                else
                {
                    while (true)
                    {
                        if (blueOne.getLifeValue() >= blueOne.getWarriorValue(bluePosition))
                        {
                            ...
                            {
                                dragon theDragon(blueOne.getCount(), blueOne.getWarriorValue(bluePosition),
                                                 blueOne.getLifeValue());
                                theDragon.print();
                            }
                            ...
                            {
                                lion theLion(blueOne.getCount(), blueOne.getWarriorValue(bluePosition),
                                             blueOne.getLifeValue());
                                theLion.print();
                            }
                            else
